...
export const addLike = id => async dispatch => {
  try {
    const result = await axios.put(`/api/posts/like/${id}`);
...
export const removeLike = id => async dispatch => {
  try {
    const result = await axios.put(`/api/posts/unlike/${id}`);
...
export const addComment = (postId, formData) => async dispatch => {
  ...
  try {
    const result = await axios.post(`/api/posts/comment/${postId}`, formData, config);
